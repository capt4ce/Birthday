        ...
        <div class="container">
          ...
          <div class="form-group col-md-6">
            <form method="post">
              ...
              <div class="progress" id="profile_pic_form_prog_container" hidden>
              ...
              <p>No picture selected as your picture</p>
              <div class="progress" id="featured_pic_form_prog_container" hidden>
            ...
            <form class="uplad" id="profile_pic_form" action="functionalities/process-upload.php" enctype="multipart/form-data" role="form" method="post" onsubmit="return false">
              <input id="profile_file" type="file" name="profile_file" onchange="prog='#'+this.id;$('#profile_pic_form').submit()">
              <button type="submit">submit</button>
            </form>
            <form class="uplad" id="featured_pic_form" action="functionalities/process-upload.php" enctype="multipart/form-data" role="form" method="post" onsubmit="return false">
              <input id="featured_file" type="file" name="featured_file" onchange="$('#featured-pic-form').submit()">
            </form>
          </div>
        </div>
      </div>
